...
// 한 가지 주의해야 할 점은 클로저가 주어진 조건을 한 번이라도 만족하지 아니하면 방출 도중 에러 유무와 상관없이 모든 항목을 방출합니다. 에러가 담긴 항목을 방출해 스트림을 중단하고 싶다면 클로저가 주어진 조건을 만족하지 아니하기 전에 에러가 담긴 항목을 방출해야 합니다.
